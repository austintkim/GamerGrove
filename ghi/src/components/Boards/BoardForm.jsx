...
const initialData = {
	...
	description: '',
	cover_photo:
		'https://img.freepik.com/premium-photo/gaming-computer-table-video-game-room-with-purple-color-neon-lighting-against-window-background-3d-illustration_76964-5151.jpg',
};
